...
class RestaurantServiceTest {
    ...
    public void searching_for_existing_restaurant_should_return_expected_restaurant_object() throws restaurantNotFoundException {
        ...
        Restaurant resMock;
        resMock = restaurantService.addRestaurant("Amelie's cafe", "Chennai", openingTime, closingTime);
        assertEquals(restaurantService.findRestaurantByName("Amelie's cafe"), resMock);
    }
